                    ...
                    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/users">
                      {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('telefone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="telefone" type="text" class="form-control" name="telefone" value="" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('tipo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tipo" type="text" class="form-control" name="tipo" value="" required autofocus>
                                @if ($errors->has('tipo'))
                                    <span class="help-block">
