    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Editar Produto e Serviços</div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/produtos/{{$produto->id }}">
                      ...
                      {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('descricao') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="descricao" type="text" class="form-control" name="descricao" value="{{ $produto->descricao }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('valorUnit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="valorUnit" type="text" class="form-control" name="valorUnit" value="{{ $produto->valorUnit }}" required autofocus>
